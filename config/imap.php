    ...
    'accounts' => [
        ...
        */
        ...
        'gmail' => [ // account identifier
            ...
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'subvention@novecology.fr',
            'password' => 'xxolwthgfpknfwkn',
            'authentication' => null,
        ],
        'gmail_two' => [ // account identifier
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'mandat@novecology.fr',
            'password' => 'ndcrtmjsabqriobz',
            'authentication' => null,
        ],
        'gmail_three' => [ // account identifier
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'supportmpr@novecology.fr',
            'password' => 'wktorrzfkevsgerm',
            'authentication' => null,
        ],
    ],
