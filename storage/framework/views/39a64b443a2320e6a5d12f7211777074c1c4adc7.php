...
<?php echo $__env->yieldPushContent('all_modals'); ?>
<?php echo $__env->yieldPushContent('all_forms'); ?>


<!-- All Scripts -->
<script src="<?php echo e(asset('crm_assets/assets/js/jquery-1.12.4.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/bootstrap/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/fontawesome/js/all.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/nice-select/js/nice-select.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/flatpickr/js/flatpickr.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/flatpickr/js/flatpicker-fr.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/simplebar/js/simplebar.min.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/check-all-rows/js/TableCheckAll.js')); ?>"></script>
<script src="<?php echo e(asset('crm_assets/assets/plugins/select2/js/select2.min.js')); ?>"></script>
<?php echo $__env->yieldPushContent('plugins-script'); ?>


<script src="<?php echo e(asset('crm_assets/assets/js/script.js')); ?>"></script>
...
<?php echo $__env->yieldPushContent('mapJS'); ?>
<?php echo $__env->yieldPushContent('js'); ?>
<?php echo $__env->yieldContent('script-js'); ?>
</body>
</html>
<?php /**PATH C:\Users\user\Desktop\SoClose\V2-Novecology-Lead\resources\views/includes/crm/footer.blade.php ENDPATH**/ ?>