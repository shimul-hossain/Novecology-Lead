...
@section('DroitOpposition', 'active')

{{-- Title --}}
@section('title')
{{ config('app.name') }} | Droit d’opposition
@endsection
    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Droit d’opposition</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Droit d’opposition</h4>
                        @if (session('success'))
                    ...
                    <div class="card-body"> 
                        <form action="{{ route('droit.opposition.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf  
