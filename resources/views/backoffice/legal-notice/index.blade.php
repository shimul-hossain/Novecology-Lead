...
@section('legalNotice', 'active')

{{-- Title --}}
@section('title')
{{ config('app.name') }} | MENTIONS LÉGALES
@endsection
    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">MENTIONS LÉGALES</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">MENTIONS LÉGALES</h4>
                        @if (session('success'))
                    ...
                    <div class="card-body"> 
                        <form action="{{ route('legal.notice.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf  
