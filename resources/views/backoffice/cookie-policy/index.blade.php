...
@section('cookiePolicy', 'active')

{{-- Title --}}
@section('title')
{{ config('app.name') }} | POLITIQUE DE COOKIES
@endsection
    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">POLITIQUE DE COOKIES</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">POLITIQUE DE COOKIES</h4>
                        @if (session('success'))
                    ...
                    <div class="card-body"> 
                        <form action="{{ route('cookie.policy.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf  
