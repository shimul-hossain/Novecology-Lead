...
@section('bandeauInformation', 'active')

{{-- Title --}}
@section('title')
{{ config('app.name') }} | BANDEAU D’INFORMATION
@endsection
    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">BANDEAU D’INFORMATION</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">BANDEAU D’INFORMATION</h4>
                        @if (session('success'))
                    ...
                    <div class="card-body"> 
                        <form action="{{ route('bandeau-information.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf  
