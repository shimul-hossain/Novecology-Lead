...
{{-- Title --}}
@section('title')
{{ config('app.name') }} | Catégorie références
@endsection
    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Catégorie références</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Liste des catégories références</h4>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('backoffice.reference.category.delete') }}" method="POST">
                                                            @csrf
                                            ...
                                            <div class="modal fade" id="editModal{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('backoffice.reference.category.update') }}" method="post">
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('backoffice.reference.category.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf  
                        <div class="form-group"> 
                            <label for="title">Titre * </label>
