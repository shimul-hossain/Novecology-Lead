...
{{-- Meta facebook title --}}
@section('fb_title', 'Pompe à chaleur Air/Eau')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Pompe à chaleur Air/Eau')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-1/service-image-2.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Pompe à chaleur Air/Eau</h1>
					<h2 class="banner__slide__card__content__title text-white d-inline-block">À partir de 2 990 €</h2>
					<br>
					...
					<div class="sub-banner__card mt-5">
						<ul class="sub-banner__card__list list-unstyled">
							<li class="sub-banner__card__list__item">60% d’économies sur votre chauffage</li>
