...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/services-details/banner-1.webp') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Chaudière à Granulés</h1>
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-4 text-center">
									...
									<a href="#!" class="btn-fat btn-fat--warning mt-3">Estimez le montant de vos aides</a>
								</div>
