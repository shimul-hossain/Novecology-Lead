...
{{-- Site title  --}}
@section('title', "Isolation Thermique par l'Extérieur (ITE)")
...
{{-- Meta facebook title --}}
@section('fb_title', "Isolation Thermique par l'Extérieur (ITE)")
...
{{-- Meta Twitter title  --}}
@section('twitter_title', "Isolation Thermique par l'Extérieur (ITE)")
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-2/service-image-1.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Isolation Thermique par l'Extérieur (ITE)</h1>
					<h2 class="banner__slide__card__content__title text-white d-inline-block">À partir de 85 €/m²</h2>
					<br>
					...
					<div class="sub-banner__card mt-5">
						<ul class="sub-banner__card__list list-unstyled">
							<li class="sub-banner__card__list__item">Jusqu’à 60% d’économies sur votre chauffage</li>
							<li class="sub-banner__card__list__item">Marque française de référence : Weber Saint Gobain</li>
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Isolation Thermique par l'Extérieur (ITE)</h1>
							</div>
