...
{{-- Site title  --}}
@section('title', "Panneaux photovoltaïques")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Panneaux photovoltaïques')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Panneaux photovoltaïques')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-3/service-image-1.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Panneaux photovoltaïques</h1>
					<h2 class="banner__slide__card__content__title text-white d-inline-block">À partir de 8 490 €</h2>
					<br>
					...
					<div class="sub-banner__card mt-5">
						<ul class="sub-banner__card__list list-unstyled">
							<li class="sub-banner__card__list__item">Jusqu’à 50% d’économies sur votre facture d’électricité</li>
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Panneaux photovoltaïques</h1>
							</div>
