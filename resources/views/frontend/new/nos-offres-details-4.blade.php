...
{{-- Site title  --}}
@section('title', "Chauffe-eau thermodynamique")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Chauffe-eau thermodynamique')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Chauffe-eau thermodynamique')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-1/service-image-4.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Chauffe-eau thermodynamique</h1>
					<h2 class="banner__slide__card__content__title text-white d-inline-block">À partir de 2 190 €</h2>
					<br>
					<span class="d-inline-block p-2 bg-light text-primary">AIDES DÉDUITES</span>
					<div class="sub-banner__card mt-5">
						<ul class="sub-banner__card__list list-unstyled">
							<li class="sub-banner__card__list__item">Divisez par 3 votre facture d’eau chaude sanitaire</li>
							<li class="sub-banner__card__list__item">Marques françaises de référence : Thaleos, Thermor</li>
							<li class="sub-banner__card__list__item">Votre estimation gratuite en 2 minutes</li>
						</ul>
						<a href="#!" class="btn btn-primary text-uppercase rounded-pill">Estimez vos économies d'énergie</a>
					</div>
				</div>
			</div>
		</div>
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Chauffe-eau thermodynamique</h1>
							</div>
							<p>Mode de chauffage préféré des Français, la pompe à chaleur Air/Air est une solution de chauffage écologique et économique. Basée sur l’utilisation d’une énergie renouvelable, la pompe à chaleur Air/Eau récupère les calories naturellement présentes dans l’air extérieur pour les restituer sous forme de chaleur au circuit de chauffage central.</p>
						</div>
					</section>
