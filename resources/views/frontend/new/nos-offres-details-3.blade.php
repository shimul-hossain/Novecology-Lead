...
{{-- Site title  --}}
@section('title', "Pompe à chaleur Air/Air")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Pompe à chaleur Air/Air')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Pompe à chaleur Air/Air')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-1/service-image-3.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">Pompe à chaleur Air/Air</h1>
					<h2 class="banner__slide__card__content__title text-white d-inline-block">À partir de 3 990 €</h2>
					<br>
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Pompe à chaleur Air/Eau</h1>
							</div>
