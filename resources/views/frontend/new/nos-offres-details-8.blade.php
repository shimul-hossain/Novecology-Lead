...
{{-- Site title  --}}
@section('title', "Système Solaire Combiné (SSC)")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Système Solaire Combiné (SSC)')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Système Solaire Combiné (SSC)')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/services-details/banner-8.webp') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Système Solaire Combiné (SSC)</h1>
							</div>
