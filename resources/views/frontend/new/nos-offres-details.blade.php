...
{{-- Site title  --}}
@section('title', "Chaudière à Granulés")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Chaudière à Granulés')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Chaudière à Granulés')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{asset('uploads/new/offer')}}/{{ $offer->banner_image }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-lg-6 ms-auto">
					<h1 class="sub-banner__title">{{ $offer->title }}</h1>
					<div class="sub-banner__card mt-5">
						<ul class="sub-banner__card__list list-unstyled">
							@foreach ($offer->bannerService as $service)
								<li class="sub-banner__card__list__item">{{ $service->name }}</li>
							@endforeach
							{{-- <li class="sub-banner__card__list__item">Modèle de référence : gamme Loki de HS France</li>
							<li class="sub-banner__card__list__item">Votre estimation gratuite en 2 minutes</li> --}}
						</ul>
						<a href="{{ $offer->banner_button_link ?? '#!' }}" class="btn btn-primary text-uppercase rounded-pill">{{ $offer->banner_button_text }}</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid px-0">
			<div class="row g-0">
				<main class="col-lg">
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">{{ $offer->title }}</h1>
							</div>
							<p>{{ $offer->long_description }}</p>
						</div>
					</section>
					@if ($offer->first_block_status == 'yes')
							...
							<div class="container">
								<div class="row">
									<div class="col-lg-4 text-center">
										...
										<a href="{{ route('estimer.vos.aides') }}" class="btn-fat btn-fat--warning mt-3">Estimez le<br> montant de vos<br> aides</a>
									</div>
									<div class="col-lg-8 mt-4 mt-lg-0">
										<h2 class="fs-4 mb-4">{{ $offer->first_block_title }}</h2>
										<p>{{ $offer->first_block_desciption }}</p>
									</div>
								</div>
							</div>
						</section>
					@endif
					@if ($offer->second_block_status == 'yes')
						<section class="section-gap">
							<div class="container">
								<div class="row flex-xl-row-reverse">
									<div class="col-lg-4 text-center">
										<img class="mx-auto" src="{{asset('uploads/new/offer')}}/{{ $offer->second_block_image }}" alt="services details" loading="lazy" draggable="false">
										<a href="{{ route('estimer.vos.aides') }}" class="btn-fat btn-fat--warning mt-3">Estimez le<br> montant de vos<br> aides</a>
									</div>
									<div class="col-lg-8 mt-4 mt-lg-0">
										<h2 class="fs-4 mb-4">{{ $offer->second_block_title }}</h2>
										<p>{{ $offer->second_block_desciption }}</p>
									</div>
								</div>
							</div>
						</section>
					@endif
					@if ($offer->third_block_status == 'yes')
						<section class="section-gap bg-light-blue">
							<div class="container">
								<h2 class="fs-4 mb-4">{{ $offer->third_block_title }}</h2>
								<div class="row">
									@foreach ($offer->thirdBlockInfo as $third_block_info)
										<div class="col-xl-3 col-lg-4 col-md-6 d-flex align-items-end">
											<div class="icon-card">
												<img class="icon-card__image" src="{{asset('uploads/new/offer')}}/{{ $third_block_info->image }}" alt="service icon" width="120" height="120" loading="lazy" draggable="false">
												<h3 class="icon-card__title fs-5">{{ $third_block_info->title }}</h3>
												<p class="icon-card__text fs-sm">{{ $third_block_info->description }}</p>
											</div>
										</div>
									@endforeach
									{{-- <div class="col-xl-3 col-lg-4 col-md-6 d-flex align-items-end">
					...
					@endif
					@if ($offer->fourth_block_status == 'yes')
						<section class="section-gap">
							<div class="container">
								<div class="row flex-xl-row-reverse">
									<div class="col-lg-4 text-center">
										<img class="mx-auto" src="{{asset('uploads/new/offer')}}/{{ $offer->fourth_block_image }}" alt="services details" loading="lazy" draggable="false">
										<a href="{{ route('estimer.vos.aides') }}" class="btn-fat btn-fat--warning mt-3">Estimez le<br> montant de vos<br> aides</a>
									</div>
									<div class="col-lg-8 mt-4 mt-lg-0">
										<h2 class="fs-4 mb-4">{{ $offer->fourth_block_title }}</h2>
										<p>{{ $offer->fourth_block_desciption }}</p>
									</div>
								</div>
							</div>
						</section>
					@endif
					@if ($offer->fifth_block_status == 'yes')
						<section class="section-gap bg-gray-light">
							<div class="container">
								<div class="row">
									<div class="col-12">
										<h2 class="fs-4 mb-4">{{ $offer->fifth_block_title }}</h2>
										<p>{{ $offer->fifth_block_description }}</p>
									</div>
								</div>
							</div>
						</section>
						<section class="section-gap bg-gray-light">
							<div class="container">
								<div class="row">
									@foreach ($offer->fifthBlockInfo as $fifth_block_info)
										<div class="col-lg-6 mb-3">
											<div class="row text-center text-md-start">
												<div class="col-md-3">
													<img src="{{asset('uploads/new/offer')}}/{{ $fifth_block_info->image }}" alt="services icon" class="mx-auto" loading="lazy" draggable="false">
												</div>
												<div class="col-md-7">
													<h2 class="fs-4 mb-2">{{ $fifth_block_info->title }}</h2>
													<p class="fs-sm">{{ $fifth_block_info->description }}</p>
												</div>
											</div>
										</div>
									@endforeach
					...
					@endif
					@if ($offer->sixth_block_status == 'yes')
						<section class="section-gap">
							<div class="container">
								<h1 class="fs-4 mb-4">{{ $offer->sixth_block_title }}</h1>
								<div class="row">
									@foreach ($offer->sixthBlockInfo as $sixth_block_info)
										<div class="col-md-6">
											<div class="text-center mb-4">
												<img class="mx-auto shadow rounded-circle" src="{{asset('uploads/new/offer')}}/{{ $sixth_block_info->image }}" alt="service icon" width="68" height="68" loading="lazy" draggable="false">
												<h3 class="text-primary fs-5 fw-light my-3">{{ $sixth_block_info->title }}</h3>
												<p class="fs-sm fw-light">{{ $sixth_block_info->description }}</p>
											</div>
										</div>
									@endforeach
									{{-- <div class="col-md-6">
