...
{{-- Site title  --}}
@section('title', "Poêle à  Granulés")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Poêle à  Granulés')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Poêle à  Granulés')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-1/service-image-5.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Poêle à  Granulés</h1>
							</div>
