...
{{-- Site title  --}}
@section('title', "Chauffe Eau Solaire")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Chauffe Eau Solaire')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Chauffe Eau Solaire')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/service-3/service-image-3.jpg') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Chauffe Eau Solaire</h1>
							</div>
