...
{{-- Meta facebook title --}}
@section('fb_title', 'Nous Contacter')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Nous Contacter')
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="section-header text-start">
						<h1 class="section-header__title">{{ $contact->title }}</h1>
					</div>
					<h3 class="text-primary">{{ $contact->subtitle }}</h3>
					<p>{{ $contact->description }}</p>
					<a href="{{ route('prendre.rdv') }}" class="btn btn-primary">Prendre rendez-vous</a>
				</div>
				<div class="col-lg-6">
					<img src="{{ asset('uploads/new/contact') }}/{{ $contact->image }}" alt="bear & map" draggable="false" loading="lazy" class="img-fluid mx-auto">
				</div>
			</div>
		</div>
	</section>
