...
{{-- Site title  --}}
@section('title', "Panneau solaire “NOMADE”")
...
{{-- Meta facebook title --}}
@section('fb_title', 'Panneau solaire “NOMADE”')
...
{{-- Meta Twitter title  --}}
@section('twitter_title', 'Panneau solaire “NOMADE”')
...
@section('content')
	...
	<section class="sub-banner">
		<div class="sub-banner__overlay">
			<img src="{{ asset('frontend_assets/new/images/services/services-details/banner-10.webp') }}" alt="services details" class="sub-banner__image">
		</div>
		<div class="container">
			<div class="row">
					...
					<section class="section-gap">
						<div class="container">
							<div class="section-header">
								<h1 class="section-header__title text-start">Panneau solaire “NOMADE”</h1>
							</div>
