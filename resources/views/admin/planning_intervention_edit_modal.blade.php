        ...
        <div class="modal-content simple-bar border-0 h-100 rounded-0">
            ...
            <div class="modal-body pt-0">
                <div class="d-flex flex-column align-items-center mb-2">
                    <h1 class="modal-title text-center">Modifier l'intervention </h1>
                ...
                <form action="{{ route('new.project.intervention.update') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        @if (checkAction(Auth::id(), 'collapse_intervention', 'edit') || role() == 's_admin')
                            <div class="col-12 text-center ">
                                <button type="submit" class="primary-btn primary-btn--primary primary-btn--lg rounded-pill d-inline-flex align-items-center justify-content-center border-0 mt-5 interventionSubmitBtn">
                                    {{ __('Submit') }}
                                </button>
                            </div>
                        @else
