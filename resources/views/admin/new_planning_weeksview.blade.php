										...
										@foreach ($week['events'] as $event)
											<div class="calendar__week__col__body">
												<div class="week-event">
                                                    <button type="button" class="calendar__row__container__event__arrow" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                                                    ...
                                                    <button type="button" class="calendar__row__container__event__arrow" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
