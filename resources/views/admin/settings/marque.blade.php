...
@section('MarquesTabActive', 'active')

@section('tab-content')
    <div class="tab-pane fade show active" id="v-pills-14" role="tabpanel" aria-labelledby="v-pills-14-tab">
                        ...
                        <tbody class="database-table__body" style="min-height: 350px">
                            @forelse ($brands as $brand)
                                <tr>
                                    ...
                                    <td>
                                        @if ($brand->logo)
                                        <img src="{{ asset('uploads/brand') }}/{{ $brand->logo }}" alt="" width="100" height="100">
                                        @endif
                                    </td>
                                    <td>
                                        {{ $brand->description }}
                                        ...
                                        <div class="dropdown dropdown--custom p-0 d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu--custom bg-white border-0 w-100" aria-labelledby="customSelectDropdown">
                                                ...
                                                @if (checkAction(Auth::id(), 'general__setting-marques', 'delete') || role() == 's_admin') 
                                                    <button type="button" data-toggle="modal" data-target="#brandModalDelete{{ $brand->id }}" class="dropdown-item border-0">
...
@section('modal-content')
    ...
    @foreach ($brands as $brand)
            ...
            <div class="modal-content simple-bar border-0 h-100 rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('brand.update') }}" class="form mx-auto needs-validation" enctype="multipart/form-data" novalidate method="POST">
                        @csrf
                        <div>
                            <img src="{{ asset('uploads/brand') }}/{{ $brand->logo }}" width="150px" alt="">
                        </div>
        ...
        <div class="modal modal--aside fade" id="brandModalDelete{{ $brand->id }}" tabindex="-1" aria-labelledby="middleModalLabel" aria-hidden="true">
