...
@section('StatutPlanningInterventionTabActive', 'active')

@section('tab-content')
<div class="tab-pane fade show active" id="v-pills-status_planning_intervention" role="tabpanel" aria-labelledby="v-pills-status_planning_intervention-tab">
