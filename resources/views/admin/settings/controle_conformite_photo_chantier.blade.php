...
@section('ContrôleConformitéPhotoChantierTabActive', 'active')

@section('tab-content')
    <div class="tab-pane fade show active" id="v-pills-project_control_photo" role="tabpanel" aria-labelledby="v-pills-project_control_photo-tab">
