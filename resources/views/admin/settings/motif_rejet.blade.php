...
@section('MotifRejetTabActive', 'active')

@section('tab-content')
    <div class="tab-pane fade show active" id="v-pills-reject_reason" role="tabpanel" aria-labelledby="v-pills-reject_reason-tab">
