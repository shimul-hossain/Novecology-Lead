...
@section('NotionCatégorieTabActive', 'active')

@section('tab-content')
    <div class="tab-pane fade show active" id="v-pills-notion_category" role="tabpanel" aria-labelledby="v-pills-notion_category-tab">
