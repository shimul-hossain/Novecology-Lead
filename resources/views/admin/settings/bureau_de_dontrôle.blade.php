...
@section('BureauContrôleTabActive', 'active')
                        ...
                        <tbody class="database-table__body" style="min-height: 350px">
                            @forelse ($controls as $control)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('uploads/control') }}/{{ $control->logo }}" alt="" width="100" height="100">
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown dropdown--custom p-0 d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu--custom bg-white border-0 w-100" aria-labelledby="customSelectDropdown">
                                                ...
                                                @if (checkAction(Auth::id(), 'general__setting-bureaux_de_controle', 'delete') || role() == 's_admin') 
                                                    <button data-toggle="modal" data-target="#controlModalDelete{{ $control->id }}" type="button" class="dropdown-item border-0">
...
@section('modal-content')
    ...
    @foreach ($controls as $control)
            ...
            <div class="modal-content simple-bar border-0 h-100 rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('control.update') }}" class="form mx-auto needs-validation" enctype="multipart/form-data" novalidate method="POST">
                        @csrf
                        <div>
                            <img src="{{ asset('uploads/control') }}/{{ $control->logo }}" width="150px" alt="">
                        </div>
                        <div class="form-group">
        ...
        <div class="modal modal--aside fade" id="controlModalDelete{{ $control->id }}" tabindex="-1" aria-labelledby="middleModalLabel" aria-hidden="true">
