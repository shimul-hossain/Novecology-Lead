...
@section('ChantiersReflexionRaisonsTabActive', 'active')

@section('tab-content')
    <div class="tab-pane fade show active" id="v-pills-project_reflection_reason" role="tabpanel" aria-labelledby="v-pills-project_reflection_reason-tab">
