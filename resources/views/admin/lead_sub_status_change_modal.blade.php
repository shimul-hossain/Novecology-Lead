<div class="modal modal--aside fade" id="leadSubStatusChangeModal" tabindex="-1" aria-labelledby="middleModalLabel" aria-hidden="true">
                    ...
                    <div class="status_change__input text-left">
                        ...
                        @if ($lead->lead_label == 5)
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="dead_reason"  id="dead-reason" class="form-control shadow-none">{{ $lead->lead_ko_reason }}</textarea>
                            </div>
                        @endif
                    </div>
