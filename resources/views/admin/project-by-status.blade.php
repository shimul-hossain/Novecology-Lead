        ...
        <tr>
            <td>
                <div class="custom-control custom-checkbox">
                    <input value="1" type="checkbox" data-project-id="{{ $project->id }}"  class="custom-control-input table-select-checkbox projectCheckboxBtn projectCheckboxBtn__{{ $key }}" id="tableRowSelectCheck-{{ $project->id }}">
            ...
            <td>
                <div>
                    <div class="first-name pl-2"><a href="{{ route('files.index', $project->id) }}">{{ $project->project_name??__('Not Provided') }}</a></div>
                </div>
            </td>
    ...
    @forelse ($item_data as $project)
        ...
        <tr>
            ...
            @foreach ($filter_status as $item)
                ...
                <td><a href="{{ route('files.index', $project->id) }}">{{ $project->project_name??__('Not Provided') }}</a></td>
                @endif
                ...
                <td><a href="{{ route('files.index', $project->id) }}">{{ $project->last_name??__('Not Provided') }}</a></td>
                @endif
                ...
                <td><a href="{{ route('files.index', $project->id) }}">{{ $project->pays??__('Not Provided') }}</a></td>
                @endif
                ...
                <td><a href="{{ route('files.index', $project->id) }}">{{ $project->zone??__('Not Provided') }}</a></td>
                @endif 

                @if($header == 'city'||$header == 'ville')
                <td><a href="{{ route('files.index', $project->id) }}">{{ $project->city??__('Not Provided') }}</a></td>
                @endif 
