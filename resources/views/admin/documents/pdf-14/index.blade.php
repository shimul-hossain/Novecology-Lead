...
<head>
    ...
    <title>PDF -14</title>
    <link rel="stylesheet" href="{{ public_path().'/crm_assets/pdf_assets/pdf-14/pdf_assets/css/style.css' }}">
</head>
<body>
    <div class="page" size ="A4">
        <div class="header-shape">
            <img src="{{ public_path().'/crm_assets/pdf_assets/pdf-14/pdf_assets/images/header-shape.png' }}" alt="header-shape">
        </div>
        <div class="main">
            <span class="title-1">FICHE INFORMATION</span>
            ...
            <br>
            <br>
            <p>Reconnait avoir été informé que cette offre est cumulable avec l'aide MaPrimeRénov', accordée uniquement après analyse du dossier, pour mon projet de <span class="solid-line"> {{ $data['travaux'] }}</span></p>
            <p>L’aide MaPrimeRénov’ est soumise à la conformité des pièces justificatives et informations déclarées par le bénéficiaire. Le montant de la subvention prévisionnelle de MaPrimeRenov’ est <span class="solid-line">{{ $data['MONTANT_Subvention_Accordé'] }}</span></p>
            <br>
            <br>
            <table>
                <tr>
