...
<head>
    ...
    <title>PDF -33</title>
    <link rel="stylesheet" href="{{ public_path().'/crm_assets/pdf_assets/pdf-33/pdf_assets/css/style.css' }}">
</head>
<body>
    <div class="header">
        <img class="d-block w-100" src="{{ public_path().'/crm_assets/pdf_assets/pdf-33/pdf_assets/images/header-shape.png' }}" alt="shape">
    </div>
    <div class="body">
        <div class="box">
            <div class="title" align="center"><strong>CONTROLE QUALITE - INSTALLATION POMPE A CHALEUR</strong></div>
        </div>
        ...
        <br>
        <p><i><strong class="large">1)</strong></i> <i><strong class="solid-line">Êtes satisfait de la pose de la POMPE A CHALEUR ?</strong></i>&nbsp;&nbsp;<span class="radio-option">OUI</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="radio-option">NON</span></p>
        <br>
