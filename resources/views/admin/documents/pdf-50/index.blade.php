...
<head>
    ...
    <title>PDF 50</title>
    <link rel="stylesheet" href="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/css/style.css' }}">
</head>
<body>
    <div class="header">
        <img class="d-block w-100" src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/header-shape.png' }}" alt="shape">
    </div>
    <div class="body">
        <div class="logo-container">
            <img class="logo-container__logo d-block" src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/logo.png' }}" alt="logo" width="220">
            <img style="margin-left: 60px;" src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/client-logo.png' }}" alt="client logo" height="30">
        </div>
        <br>
        <h1 class="title" align="center"><span class="solid-line">INSTALLATION PAC</span></h1>
        <div class="box">
        ...
        <table>
            <tr>
                <td>
                    <img src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/checkbox.png' }}" alt="checkbox" width="50">
                </td>
        ...
        <table>
            <tr>
                ...
                <td style="padding-left: 15px;"><strong>PHOTO POMPE A CHALEUR</strong></td>
            </tr>
            <tr>
                <td>
                    <img src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/checkbox.png' }}" alt="checkbox" width="50">
                </td>
                <td style="padding-left: 15px;"><strong>PHOTO DU BALLON ECS</strong></td>
            </tr>
            <tr>
                <td>
                    <img src="{{ public_path().'/crm_assets/pdf_assets/pdf-50/pdf_assets/images/checkbox.png' }}" alt="checkbox" width="50">
