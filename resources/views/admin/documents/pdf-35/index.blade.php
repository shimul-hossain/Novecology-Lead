...
<head>
    ...
    <title>PDF -35</title>
    <link rel="stylesheet" href="{{ public_path().'/crm_assets/pdf_assets/pdf-35/pdf_assets/css/style.css' }}">
</head>
<body>
    <div class="header">
        <img class="d-block w-100" src="{{ public_path().'/crm_assets/pdf_assets/pdf-35/pdf_assets/images/header-shape.png' }}" alt="shape">
    </div>
    <div class="body">
        <div class="box">
            <div class="title" align="center"><strong>CONTROLE QUALITE - INSTALLATION SYSTEME SOLAIRE COMBINE - NOVECOLOGY</strong></div>
        </div>
        ...
        <br>
        <p><i><strong class="large">1)</strong></i> <i><strong class="solid-line">Êtes satisfait de la pose de la SYSTEME SOLAIRE COMBINE ?</strong></i>&nbsp;&nbsp;<span class="radio-option">OUI</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="radio-option">NON</span></p>
        <br>
        ...
        <br>
        <p><strong class="large">6)</strong><strong><i>Évaluation globale <u>(de 1 à 10)</u> à l’ensemble de la prestation</i></strong> <i>(accueil et explication du commercial, présentation du technicien, pose SSC)</i></p>
        <br>
