<ul class="nav nav-pills justify-content-center mb-3" id="pills-tab" role="tablist">
    @foreach ($category->subCategories as $sub_category)
        <li class="nav-item pl-2" role="presentation">
          <button type="button" class="nav-link subCategoryFitler" data-id="{{ $sub_category->id }}" id="pills-profile-tab" data-toggle="pill" role="tab"  aria-selected="false">{{ $sub_category->name }}</button>
        </li>
    @endforeach
</ul>
<div class="row notionWrap" id="subCategoryWrap">
