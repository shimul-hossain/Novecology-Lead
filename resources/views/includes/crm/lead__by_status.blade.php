                        ...
                        <div class="avatar-group d-flex"> 
                            @if ($lead->leadTelecommercial)
                                <a href="#!" class="avatar-group__image-wrapper rounded-circle overflow-hidden" data-toggle="tooltip" data-placement="top" title="{{ $lead->leadTelecommercial->name }}">
                                    ...
                                    <img src="{{ asset('uploads/crm/profiles') }}/{{ $lead->leadTelecommercial->profile_photo }}" alt="{{ $lead->leadTelecommercial->name }}" class="avatar-group__image w-100 h-100">
                                    @else
                        ...
                        @else
                            @if ($lead->lead_label == 6)
                                @if (role() == 'manager' || role() == 's_admin')
                                    <button type="button" class="next-btn d-inline-flex justify-content-center align-items-center rounded-circle" data-target="#lead_status__change{{ $lead->id }}" data-toggle="modal"><span class="novecologie-icon-chevron-right"></span></button> 
                                @else
                                ...
                                <div class="status_change__input text-left" style="display: none">
                                    <div class="form-group mt-3">
                                        ...
                                        <select name="status" id="lead_staus_new{{ $lead->id }}" class="select2_select_option custom-select shadow-none form-control lead_staus__change" required>
                                            ...
                                            <option {{ $lead->lead_label == 6 ? 'selected':'' }} value="6">Validation</option>  
                                        </select>
                                    </div>
                                    <div class="form-group mt-3">
