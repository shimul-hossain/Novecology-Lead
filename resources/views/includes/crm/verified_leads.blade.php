...
@foreach ($verified_leads as $lead)
@if (role() != 's_admin')
...
<tr>
    <td>
        <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input table-select-checkbox verified_lead_checked" data-id="{{ $lead->id }}" id="tableThreeRowSelectCheck-{{ $lead->id }}">
...
<tr>
    <td>
        <div class="custom-control custom-checkbox">
            <input type="checkbox" name="checkedLead[]" value="{{ $lead->id }}" class="custom-control-input table-select-checkbox verified_lead_checked" data-id="{{ $lead->id }}" id="tableThreeRowSelectCheck-{{ $lead->id }}">
            <label class="custom-control-label" for="tableThreeRowSelectCheck-{{ $lead->id }}"></label>
        </div>
    </td> 
