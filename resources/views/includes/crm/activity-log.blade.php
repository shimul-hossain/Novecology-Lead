                                ...
                                <div class="d-sm-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        @elseif ($activity->key == 'gestionnaire__change')
                                            <p class="mb-1">
                                                {{ $activity->getUser->name }}  Attribuer un gestionnaire  à <strong> {{ $activity->assignUser->name ?? '' }}  </strong> 
                                            </p>
                                        @elseif ($activity->key == 'new_project__create')
                                            <p class="mb-1">
                                                <strong> {{ $activity->getUser->name }} a créé ce chantier</strong> 
                                            </p> 
