        ...
        <div class="col-12 mb-4">
            <div class="row align-items-center pb-3 mb-3">
                ...
                {{-- @if (checkAction(Auth::id(), 'collapse_tax_notice', 'edit') || role() == 's_admin')  --}}
                    ...
                    {{-- <div class="col-auto">
                        <form action="{{ route('lead.tax.remove') }}" method="POST">
                            @csrf
                    ...
                    <div class="modal-body pt-0">
                        ...
                        <form action="#!">
                            ...
                            <div class="text-center lead__card__btn-wrapper" id="tax__card__btn2{{ $item->id }}">
                                <button type="button" data-id="{{ $item->id }}" class="primary-btn primary-btn--primary primary-btn--lg rounded-pill d-inline-flex align-items-center justify-content-center border-0 mt-5 taxValiderBtn2 tax_input_disabled">
                                    Passer
                                </button>
