        ...
        <div class="col-12">
            <div class="card"> 
                <div class="card-body">  
                    ...
                    <form action="{{ route('project.tax.declarant.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="text-center my-3"> 
                            <button type="submit" class="primary-btn primary-btn--primary primary-btn--lg rounded-pill border-0 mt-3">
                                Valider
                            </button> 
                        </div>
                    </form> 
