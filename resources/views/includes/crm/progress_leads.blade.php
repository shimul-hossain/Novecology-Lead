...
@foreach ($progress_leads as $lead)
@if (role() != 's_admin')
    ...
    <tr>
        <td>
            <div class="custom-control custom-checkbox"> 
                <input type="checkbox"name="checkedLead[]" value="{{ $lead->id }}" class="custom-control-input table-select-checkbox progress_lead_checked progress_leads_checked" data-id="{{ $lead->id }}"  id="tableThreeRowSelectCheck-{{ $lead->id }}">
