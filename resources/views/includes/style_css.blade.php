<style>
    ...
    @import url("{{ asset('frontend_assets/fonts/novecology-icons/style.css') }}");
    ...
    *::after {
    ...
    ::-moz-selection {
        color: #fff;
        background: {{ colorSetting()->theme_color }}
    }
    ...
    .section-header__title {
        color: {{ colorSetting()->theme_color }};
        font-size: 1.875rem;
        font-weight: 300;
        line-height: 1
    }
    ...
    .primary-bg {
        background-color: {{ colorSetting()->theme_color }}
    }
    ...
    .form-control:focus {
        border-color: {{ colorSetting()->theme_color }}
    }
    ...
    .navbar-toggler__icon::after {
        ...
        -o-transform 0.5s cubic-bezier(0,.785,0,1)}.navbar-toggler[aria-expanded="true"] {
            ...
            .banner__form::before {
                ...
                bottom: 0;
                left: 0;
                background-color: {{ colorSetting()->footer_color }}
            }

            .banner__form .form-control,
            .banner__form .form-control::placeholder {
                color: {{ colorSetting()->footer_color }}
            }
            ...
            .project-card__footer__btn {
                ...
                background-color .25s ease-in-out}.project-card__footer__btn:hover,.project-card__footer__btn:active,.project-card__footer__btn:focus-visible{color:#5bc4b4;background-color:{{ colorSetting()->footer_color }}}.match-height>[class*="col"] {
                    display: flex;
                    flex-flow: column
                }
