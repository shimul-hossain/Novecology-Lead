    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Banner Form</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="data_table">
                            ...
                            <tbody>@foreach ($data as $item) <tr>
                                    ...
                                    <td> 
                                        <span> {{ \Carbon\Carbon::parse($item->created_at)->locale(app()->getLocale())->translatedFormat('d-F-Y') }}</span> 
                                    </td>
                                    <td>
                                        <span>{{$item->department}}</span>
                                    </td>
                                    <td>
                                        <span>{{ $item->getTravaux->travaux }}</span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form action="{{ route('banner.form.delete') }}"
                                                method="POST">
...
<div class="modal fade" id="bulkDeleteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="{{ route('bannerform.bulk.delete') }}" method="post" class="py-1">
                @csrf
...
<div class="modal fade" id="bulkExportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('bannerform.bulk.download') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="demo-inline-spacing">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="name" value="name" class="custom-control-input" id="download_first_name" checked>
                    ...
                    <div class="demo-inline-spacing">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="department" value="department" class="custom-control-input" id="download_department" checked>
                            <label class="custom-control-label" for="download_department">{{ __('Department') }}</label>
                        </div>
                    </div>  
                    <div class="demo-inline-spacing">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" name="travaux" value="travaux" class="custom-control-input" id="download_travaux" checked>
                            <label class="custom-control-label" for="download_travaux">{{ __('Travaux') }}</label>
                        </div>
                    </div>  
                </div>
