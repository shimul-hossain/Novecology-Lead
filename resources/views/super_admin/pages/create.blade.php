    ...
    <div class="row breadcrumbs-top">
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">{{ __('Create Pages') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="long_description">{{ __('Description') }}<span class="text-danger">*</span></label>
                            <input name="long_description" value="{{ old('long_description')}}" id="long_description"
                                type="hidden">
                            <trix-editor row="10" input="long_description" placeholder="Description"></trix-editor>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input name="list" value="{{ old('list')}}" id="list"
                                type="hidden">
