        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Our Solution Details</h4>
                    @if (session('success'))
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <form action="{{ route('solutionDetails.destroy',$item->id) }}"
                                                    method="POST">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
    
                                                    <a class="dropdown-item"
                                                        href="{{ route('solutionDetails.destroy',$item->id) }}"
