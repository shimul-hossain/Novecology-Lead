...
class CreateLeadClientProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lead_client_projects', function (Blueprint $table) {
            $table->id();
            $table->integer('company_id')->nullable();
            $table->integer('lead_status')->default(0);
            $table->integer('lead_label')->nullable();
            $table->integer('sub_status')->nullable();
            $table->integer('lead_telecommercial')->nullable();
            $table->integer('lead_user_id')->nullable();
            $table->integer('lead_deleted_status')->default(0);
             
            // $table->integer('client_status')->default(0);
            // $table->integer('client_label')->default(0);
            // $table->integer('client_sub_status')->nullable(); 
            // $table->integer('client_user_id')->nullable();
            // $table->integer('client_deleted_status')->default(0);
            ...
            // $table->integer('project_user_id')->nullable(); 
            // $table->integer('project_deleted_status')->default(0);
            
            $table->text('lead_ko_reason')->nullable();
    ...
    {
        Schema::dropIfExists('lead_client_projects');
    }
}
